...
import { AddressString, Callback } from "./types/common";
...
export declare class WalletLinkProvider extends EventEmitter implements Web3Provider {
    ...
    readonly selectedAddress: AddressString | undefined;
    readonly networkVersion: string;
    readonly isWalletLink: boolean;
