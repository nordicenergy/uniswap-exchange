...
function createWeb3ReactRoot(key) {
  ...
  return function Web3ReactProvider(_ref) {
    ...
    var library = React.useMemo(function () {
      return active && !!connector ? getLibrary(provider, connector) : undefined;
    }, [active, getLibrary, provider, connector]);
...
/*#__PURE__*/
createWeb3ReactRoot(PRIMARY_KEY);
